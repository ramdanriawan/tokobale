	...
	<div style="margin: 5px; padding:5px 10px 5px 10px; border: 1px solid black; background-color: white;">
		<form action="" method="get">
			<div style=" float: left; display: block; margin-top: 5px;">
				<input type="date" name="start_date" value="<?php echo date("Y-m-d"); ?>"> Sampai ke: 
		 ...
		 <a href="./index.php" class="btn btn-success" style="margin-left: 10px;margin-top: 5px;"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Kembali</a> <a href="./index.php" class="btn btn-secondary" style="margin-left: 10px;margin-top: 5px;" onclick="window.open(location.href.replace('laporan.php', 'print.php'), '_blank')"><span class="glyphicon glyphicon-print"></span>&nbsp;Print</a>
