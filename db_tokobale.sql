...
(4, 5, 5, 7, 'Yanti', '234567890', '2019-07-05', 'buktitransfer.jpg');
...
(5, 'Yanti Tan', 'perempuan', 'jambi', '2019-04-01', 'thehok', 0, '081345231415', 'yanti@gmail.com', 'yanti', '12345', '2019-04-14'),
(6, 'Yusuf', 'Laki-laki', 'maluku', '1997-11-02', 'muaro jambi', 0, '081232123422', 'yusuf123@gmail.com', 'yusuf', '9876', '2019-04-16'),
(10, 'Chanyeol', 'laki-laki', 'Kuala Enok', '1995-10-10', 'thehok', 3, '081345231451', 'yeol@gmail.com', 'yeol', '$2y$10$vnZ7ADYmVJpp3', '2019-07-16'),
(12, 'marijan', 'laki-laki', 'goa', '1990-12-02', 'serah', 1, '099999999999', 'ramdanriawan3@gmail.com', 'ramdanriawan3', '$2y$10$S1ceKWtuFLNLEAT0VlVgJORLXExvf.m77d7iy/GOYV9HxN2NpWOu.', '0090-09-09');
...
--
ALTER TABLE `produk`
  MODIFY `kodeproduk` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=39;
...
ALTER TABLE `konfirmasi`
  ...
  ADD CONSTRAINT `konfirmasi_ibfk_3` FOREIGN KEY (`kode_bank`) REFERENCES `bank` (`kode_bank`) ON DELETE CASCADE ON UPDATE CASCADE;
